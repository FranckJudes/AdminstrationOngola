                        ...
                        <td>
                            <div class="dropdown d-inline">
                                ...
                                <div class="dropdown-menu">
                                  ...
                                  <a class="dropdown-item has-icon" href="{{route('partenaire_associes',$item->id)}}"  ><i class="far fa-clock"></i> Les partenaires associes</a>
                                </div>
                              </div>
                        </td>
                      </tr>
...
<div class="modal-dialog modal-dialog-centered" role="document">
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title" id="exampleModalCenterTitle"> Mettre a jour L'administrateur : </h5>
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
    </div>
    <form action="{{route('admin.update',1)}}" method="POST">
             @method('PATCH')
        @csrf
